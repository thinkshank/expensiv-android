...
public class BankSMSListCommands extends Activity {
	...
	private void showDebits() {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				Intent intent = new Intent(BankSMSListCommands.this,
	...
	private void showCommandsList(String bankname){

		
		List<BankSMS> values = datasource.getAllCommandsForBank(bankname);
	...
	//			this, R.layout.view_categorywise_expense_item_row, values);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				// "Swipe from Left To Right on a selection for details",
				// Toast.LENGTH_LONG).show();
				selected = ((BankSMS) adapter
						.getItem(position));
				getAlertDialog(selected).show();
			}
		});
	
	}
	
	public AlertDialog getAlertDialog(BankSMS banksms) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		if (banksms!=null) {
			builder.setTitle(banksms.getTitle()).setMessage("SMS : " + banksms.getSmsText() + " \n TO : " + banksms.getPhoneNo());
		} else {
		...
		builder.setPositiveButton("Send", new DialogInterface.OnClickListener() {				
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				Intent intent = new Intent( Intent.ACTION_VIEW, Uri.parse( "sms:" + BankSMSListCommands.this.selected.getPhoneNo() ) );
				intent.putExtra( "sms_body", BankSMSListCommands.this.selected.getSmsText());
				startActivity( intent );
		 	startActivity(intent);
		 	finish();
			}
