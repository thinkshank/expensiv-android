...
public class BankSMSDatasource {
	
	private SQLiteDatabase database;
	private MySqlLiteHelper dbhelper;
	private String[] allCols = 
		{
		MySqlLiteHelper.BANK_SMS_ID,
		MySqlLiteHelper.BANK_SMS_SERVICE_PROVIDER,
		MySqlLiteHelper.BANK_SMS_TITLE,
		MySqlLiteHelper.BANK_SMS_PHONE_NO,
		MySqlLiteHelper.BANK_SMS_SMS_TEXT,
		MySqlLiteHelper.BANK_SMS_DESCRIPTION,
		MySqlLiteHelper.BANK_SMS_CREATED_BY		
		};
	
	public BankSMSDatasource(Context context){
